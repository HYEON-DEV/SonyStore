...
CREATE TABLE `today_sales` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '??련번호',
  `date` date NOT NULL COMMENT '??짜',
  `total` int NOT NULL DEFAULT '0' COMMENT '매출',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=112 DEFAULT CHARSET=utf8 COMMENT='???매출';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-12-30 17:55:22
