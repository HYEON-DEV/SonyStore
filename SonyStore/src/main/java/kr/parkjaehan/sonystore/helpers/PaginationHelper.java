package kr.parkjaehan.sonystore.helpers;
...
public class PaginationHelper {
    ...
    private int groupCount = 3;  // 한 그룹에 표시할 페이지번호 개수
    ...
    public PaginationHelper(int nowPage, int totalCount, int listCount, int groupCount) {
        // 멤버변수에 파라미터 복사
